...
class WikiSpider(scrapy.Spider):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.allowed_domains = ['zh.wikipedia.org']
    # 获取每个关键词的wiki搜索初始网址（第一页）
        ...
        url = "https://zh.wikipedia.org/w/index.php?title=Special:Search&limit=20&offset=0&profile=default&search=" + self.keyword + "&ns0=1"
    ...
    def parse(self, response):
        ...
        for i in range(len(web_node_list_href)):
            web_node_url = "https://zh.wikipedia.org" + str(web_node_list_href[i])
    ...
    def new_parse(self, response):
        ...
        item = {"keyword": self.keyword, "source": Source, "title": Title, "url": Website, "date": ' ', "content": Content, "attributes": attributes}
